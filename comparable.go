...
// Return true if this key is equal to the supplied FloatKey.
func (me FloatKey) EqualTo(other Comparable) bool {
	return me == other.(FloatKey)
}

// Return true if this key is greater than the supplied FloatKey.
func (me FloatKey) GreaterThan(other Comparable) bool {
	return me > other.(FloatKey)
}

// Return the int value as an interface
func (me FloatKey) ValueOf() interface{} {
	return float64(me)
}
...
func (me ByteSliceKey) LessThan(other Comparable) bool {
	if len(me) > len(other.(ByteSliceKey)) {
		return false
	}
	if len(me) < len(other.(ByteSliceKey)) {
		return true
